...
class DataBackup implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     *
     * @maps provider
     * @factory \VerizonLib\Models\DataBackupProviderEnum::checkValue
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->provider)) {
            $json['provider']  = DataBackupProviderEnum::checkValue($this->provider);
        }
