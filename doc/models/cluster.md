...
| `spec` | [`?ClusterSpec`](../../doc/models/cluster-spec.md) | Optional | - | getSpec(): ?ClusterSpec | setSpec(?ClusterSpec spec): void |
| `status` | [`?ClusterStatus`](../../doc/models/cluster-status.md) | Optional | - | getStatus(): ?ClusterStatus | setStatus(?ClusterStatus status): void |
